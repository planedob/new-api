...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.RelayErrorAudit())
	...
	geminiRouter.Use(middleware.RelayErrorAudit())
	...
	geminiCompatibleRouter.Use(middleware.RelayErrorAudit())
	...
	playgroundRouter.Use(middleware.RelayErrorAudit())
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.Distribute(), middleware.TokenConcurrencyGate())
	...
	}
	{
		...
		httpRouter.Use(middleware.Distribute(), middleware.TokenConcurrencyGate())
	...
	relayMjRouter.Use(middleware.RelayErrorAudit())
	relayMjRouter.Use(middleware.SystemPerformanceCheck())
	registerMjRouterGroup(relayMjRouter)

	relayMjModeRouter := router.Group("/:mode/mj")
	relayMjModeRouter.Use(middleware.RouteTag("relay"))
	relayMjModeRouter.Use(middleware.RelayErrorAudit())
	...
	relaySunoRouter.Use(middleware.RelayErrorAudit())
	relaySunoRouter.Use(middleware.SystemPerformanceCheck())
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.TokenConcurrencyGate())
	{
	...
	relayGeminiRouter.Use(middleware.RelayErrorAudit())
	relayGeminiRouter.Use(middleware.SystemPerformanceCheck())
	relayGeminiRouter.Use(middleware.TokenAuth())
	relayGeminiRouter.Use(middleware.ModelRequestRateLimit())
	relayGeminiRouter.Use(middleware.Distribute(), middleware.TokenConcurrencyGate())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.TokenConcurrencyGate())
	{
