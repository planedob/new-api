...
var localModelCatalogDefinitions = []localModelCatalogDefinition{
	...
	{Model: "glm-5.2", Vendor: "智谱", Group: "国产模型", Operations: []string{"chat", "responses"}, ParameterBounds: map[string]any{"stream": true, "max_tokens": 32768}, Cataloged: true, Selectable: true, Testable: true, Verified: "unknown", VerificationScope: "LOCAL_FIXTURE", PriceSummary: "按 token（脱敏快照）", Performance: map[string]any{"latency_ms": nil, "success_rate": nil, "throughput": "unknown"}, Tags: []string{"文本", "国产"}, EndpointType: "chat"},
	{Model: "kimi-k3", Vendor: "月之暗面", Group: "国产模型", Operations: []string{"chat"}, ParameterBounds: map[string]any{"stream": true, "max_tokens": 32768}, Cataloged: true, Selectable: true, Testable: true, Verified: "unknown", VerificationScope: "LOCAL_FIXTURE", PriceSummary: "按 token（脱敏快照）", Performance: map[string]any{"latency_ms": nil, "success_rate": nil, "throughput": "unknown"}, Tags: []string{"文本", "国产"}, EndpointType: "chat"},
